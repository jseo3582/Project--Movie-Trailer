...
pearl_harbor = media.Movie("Pearl Harbor",
	...
	"https://images-na.ssl-images-amazon.com/images/M/MV5BMTQ3MDc0MDc1NF5BMl5BanBnXkFtZTYwODI1ODY2._V1_.jpg",
...
tears_of_the_sun = media.Movie("Tears of The Sun",
	...
	"https://images-na.ssl-images-amazon.com/images/M/MV5BMmI3YjQ4NjctZTk0Zi00ZDFhLTgyZjAtYWRjZTJjMjMwNjM2L2ltYWdlL2ltYWdlXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_.jpg",
	"https://youtu.be/rMuX3uGQfic")

furious_seven = media.Movie("Furious 7",
	"Deckard Shaw seeks revenge against Dominic Toretto and his family for his comatose brother. RIP Paul Walker.",
...
star_trek_into_darkness = media.Movie("Star Trek Into Darkness ",
	...
	"https://images-na.ssl-images-amazon.com/images/M/MV5BMTk2NzczOTgxNF5BMl5BanBnXkFtZTcwODQ5ODczOQ@@._V1_SY1000_CR0,0,674,1000_AL_.jpg",
...
saving_private_ryan = media.Movie("Saving Private Ryan",
	...
	"https://images-na.ssl-images-amazon.com/images/M/MV5BZjhkMDM4MWItZTVjOC00ZDRhLThmYTAtM2I5NzBmNmNlMzI1XkEyXkFqcGdeQXVyNDYyMDk5MTU@._V1_SY1000_CR0,0,679,1000_AL_.jpg",
...
black_hawk_down = media.Movie("Black Hawk Down",
	...
	"https://images-na.ssl-images-amazon.com/images/M/MV5BYWMwMzQxZjQtODM1YS00YmFiLTk1YjQtNzNiYWY1MDE4NTdiXkEyXkFqcGdeQXVyNDYyMDk5MTU@._V1_SY1000_SX675_AL_.jpg",
	"https://youtu.be/5Y1ju8QwpQM")

we_were_soldiers = media.Movie("We Were Soldiers",
	"The story of the first major battle of the American phase of the Vietnam War and the soldiers on both sides that fought it, while their wives wait nervously and anxiously at home for the good news or the bad news.",
	"https://images-na.ssl-images-amazon.com/images/M/MV5BMDdmN2VmNmYtOGExNC00MmE4LTliOTUtOGMzMzFhMTNlOTM1L2ltYWdlXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_.jpg",
	"https://youtu.be/If-UCjzRFfk")

the_hurt_locker = media.Movie("The Hurt Locker",
	"During the Iraq War, a Sergeant recently assigned to an army bomb squad is put at odds with his squad mates due to his maverick way of handling his work.",
	"https://images-na.ssl-images-amazon.com/images/M/MV5BNzEwNzQ1NjczM15BMl5BanBnXkFtZTcwNTk3MTE1Mg@@._V1_.jpg",
	"https://youtu.be/hqsnhopttVw")

act_of_valor = media.Movie("Act Of Valor",
